class Cliente:
    def __init__(self, id_cliente, nome, telefone, email, cpf):  # Adicionado o : aqui
        self.id_cliente = id_cliente
        self.nome = nome
        self.telefone = telefone
        self.email = email
        self.cpf = cpf  # Removido espaço extra


class Secretaria:
    def __init__(self, id_secretaria, nome, email, senha):
...
class Procedimento:
    def __init__(self, id_proc, nome, preco, duracao):
...
class Atendimento:  
    def __init__(self, id_agendamento, cliente, data_hora):
